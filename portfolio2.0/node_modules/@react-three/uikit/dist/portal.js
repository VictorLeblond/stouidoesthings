...
export const Portal = forwardRef(({ children, dpr, frames = Infinity, renderPriority = 0, eventPriority = 0, ...props }, ref) => {
    ...
    return (_jsxs(_Fragment, { children: [reconciler.createPortal(_jsx(context.Provider, { value: usePortalStore, children: _jsxs(ChildrenToFBO, { renderPriority: renderPriority, frames: frames, fbo: fbo, children: [children, _jsx("group", { onPointerOver: () => null })] }) }), usePortalStore, null), _jsx(Image, { src: texture, objectFit: "fill", keepAspectRatio: false, ...props, ref: imageRef })] }));
});
