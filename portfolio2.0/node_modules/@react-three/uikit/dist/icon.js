...
export const Icon = forwardRef((properties, ref) => {
    ...
    return (_jsxs(AddHandlers, { properties: properties, ref: outerRef, handlers: internals.handlers, children: [_jsx("primitive", { object: internals.interactionPanel }), _jsx("primitive", { object: internals.iconGroup })] }));
});
