...
export const CustomContainer = forwardRef((properties, ref) => {
    ...
    return (_jsx(AddHandlers, { properties: properties, handlers: internals.handlers, ref: outerRef, children: _jsx(ParentProvider, { value: undefined, children: _jsx("mesh", { ref: innerRef, matrixAutoUpdate: false, geometry: panelGeometry, customDepthMaterial: properties.customDepthMaterial, customDistanceMaterial: properties.customDistanceMaterial, children: properties.children }) }) }));
});
